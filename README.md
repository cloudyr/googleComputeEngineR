...
* Carl Boettiger and Dirk Eddelbuettel for the [`rocker` project](https://hub.docker.com/u/rocker/) that Docker containers some of the R templates used in this package. 
