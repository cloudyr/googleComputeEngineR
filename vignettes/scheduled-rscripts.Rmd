...
After the image has built, you can call it to be called via a scheduled CRON task via the new dedicated function, `gce_vm_scheduler` and `gce_schedule_docker`
