...
This workflow takes advatage of the [`future`](https://cran.r-project.org/web/packages/future/index.html) integration to run your local R-functions within a cluster of GCE machines.  
