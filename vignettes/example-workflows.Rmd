...
vm <- gce_vm(name = "schedule-r", template = "r-base")

## the r-base container won't run when a process isn't running

## install R packages in the container, and commit it to the same image
gce_future_install_packages(vm, "rocker/r-base", cran_packages = "corpcor")

## see the installed package on the rocker/r-base image
docker_run(vm, "rocker/r-base", c("Rscript", "-e", "'installed.packages()'"))
#            Package      LibPath                         Version   Priority     
# corpcor    "corpcor"    "/usr/local/lib/R/site-library" "1.6.8"   NA           
# digest     "digest"     "/usr/local/lib/R/site-library" "0.6.10"  NA 
# ....
