...
1. Create your Shiny app and place in subfolder of your build folder
2. Create a Dockerfile in build folder, including copying the Shiny app into the Docker image
...
You can now deploy your Shiny app by calling it from your Container Registry:
...
Now you have a built app, you can deploy it to other instances simply by leaving out the dockerfolder and using the same `app_image` argument
...
gce_shiny_addapp(vm, app_image = "gceshinygoogleauthrdemo")
```
